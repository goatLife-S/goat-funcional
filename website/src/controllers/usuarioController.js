                ...
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        console.log(resultadoAutenticar);
                                    ...
                                    res.json({
                                        idFazenda: resultadoAutenticar[0].idFazenda,
...
function cadastrar(req, res) {
    ...
    if (razao == undefined) {
        ...
        res.status(400).send("Sua número do endereço está undefined!");
        ...
        usuarioModel.cadastrar(razao, nome, email, telefone, cnpj, cep, numeroend, complemento, senha)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
